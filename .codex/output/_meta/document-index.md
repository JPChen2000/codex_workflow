...
Track the canonical workflow documents that exist in this repository.
...
- `.codex/output/_templates/requirement-analysis.template.md`
- `.codex/output/_templates/structure.template.md`
- `.codex/output/_templates/rule.template.md`
- `.codex/output/_templates/api.template.md`
- `.codex/output/_templates/change-report.template.md`
- `.codex/output/_templates/review-report.template.md`

## Update Guidance

- Add new canonical workflow artifacts here when the scaffold grows.
- Remove entries only when the repository intentionally retires a canonical artifact.
